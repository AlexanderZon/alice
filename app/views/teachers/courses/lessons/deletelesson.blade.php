				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="portlet-title">
							<h4 class="profile-usertitle-name">Eliminar Lección	
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="deletelesson-form" action="" method="post" class="form-horizontal ajax-form" data-url="{{ $route }}/deletelesson" enctype="multipart/form-data">
								<div class="form-body">
									<h3 >¿Desea eliminar la lección {{ $lesson->title }}?</h3>
	...
	<script type="text/javascript">
		...
		window.history.pushState("", "", '/teachers/courses/show/{{ Hashids::encode($course->id) }}?section=lessons&action=deletelesson&lesson_id={{ Hashids::encode($lesson->id) }}');
		document.title = 'Alice | {{ $course->title }} | {{ $lesson->title }} | Eliminar Lección';
