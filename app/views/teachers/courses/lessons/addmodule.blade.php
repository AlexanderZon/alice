				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="addmodule-form" action="" method="post" class="form-horizontal ajax-form" data-url="{{ $route }}/addmodule" enctype="multipart/form-data">
								<div class="form-body">
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<button type="submit" class="btn green tooltips" data-original-title="Guardar Nuevo Módulo">Enviar</button>
	...
	<script type="text/javascript">
		...
		document.title = 'Alyce | {{ $course->title }} | Añadir Módulo';
