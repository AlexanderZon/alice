								...
								<div class="row">
									<div class="col-md-4">
										<ul class="ver-inline-menu tabbable margin-bottom-10">
											...
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Quinta Pregunta... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Sexta Pregunta... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Otra Pregunta... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Otra más... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Y más... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> De nuevo... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> No se acaban... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Ola ke ase... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Interminable... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Me estás tomando el pelo?... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> De muerte lenta... </a>
											</li>
											<li>
												<a data-toggle="tab" href="#tab_4-4">
												<i class="fa fa-cube"></i> Vivaa! la ultima... </a>
											</li>
										</ul>
									</div>
									<div class="col-md-8">
