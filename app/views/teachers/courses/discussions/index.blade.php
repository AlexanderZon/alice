		...
		<div class="portlet light" data-course="{{ Hashids::encode($course->id) }}">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="row">&nbsp;</div>
					<div class="row">&nbsp;</div>
					<div class="portlet-portlet-body form discussions" data-course="{{ Hashids::encode($course->id) }}">
									...
									@for($i = 0, $rows = $separator; $i < $discussions->count(); $i++)
										...
										@if($discussions[$i]->status == 'active')
											<div class="news-blocks discussion-block" data-discussion="{{ Hashids::encode($discussions[$i]->id)}}">
												...
												<a href="javascript:;" class="news-block-btn discussion-edit tooltips" data-original-title="Gestionar Discusión" data-placement="{{ $col != 3 ? 'right' : 'left'}}">
													Gestionar <i class="m-icon-swapright m-icon-black"></i>
												</a>
											</div>
										@else
