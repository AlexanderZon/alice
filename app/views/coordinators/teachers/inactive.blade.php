				...
				<div class="portlet box green-haze">
					...
					<div class="portlet-body">
						...
						<tr>
							...
							@if(Auth::user()->hasCap('coordinators_teachers_get_show') OR Auth::user()->hasCap('coordinators_teachers_get_update') OR Auth::user()->hasCap('coordinators_teachers_get_delete'))
								<th>
									 Acciones
								</th>
							@endif
						...
						<tr>
							...
							@elseif( $teacher->status == 'inactive' )
								@if(Auth::user()->hasCap('coordinators_teachers_get_activate'))
									<a href="{{ $route . '/activate/' . Hashids::encode($teacher->id) }}" class="tooltips" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Activar"><span class="label bg-yellow-saffron">{{ 'Inactivo' }}</span>
								@else
									{{ $teacher->status == 'active' ? 'Activo' : 'Inactivo' }}
								@endif
							@else
							...
							@if(Auth::user()->hasCap('coordinators_teachers_get_show') OR Auth::user()->hasCap('coordinators_teachers_get_update') OR Auth::user()->hasCap('coordinators_teachers_get_delete'))
								<td>
									@if( $teacher->status == 'active' )
										@if(Auth::user()->hasCap('coordinators_teachers_get_show'))
											&nbsp;&nbsp;
											<a class="font-blue-steel tooltips fancybox fancybox.ajax" href="{{ $route . '/show/' . Hashids::encode($teacher->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Visualizar"> <i class="fa fa-eye"></i> </a> 
										@endif
									@elseif( $teacher->status == 'inactive' )
										@if(Auth::user()->hasCap('coordinators_teachers_get_show'))
											&nbsp;&nbsp;
										...
										@if(Auth::user()->hasCap('coordinators_teachers_get_update'))
											&nbsp;&nbsp;
											<a class="font-yellow-crusta tooltips" href="{{ $route . '/update/' . Hashids::encode($teacher->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Editar"> <i class="fa fa-pencil"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('coordinators_teachers_get_delete'))
											&nbsp;&nbsp;
											<a class="font-red-sunglo tooltips" href="{{ $route . '/delete/' . Hashids::encode($teacher->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Eliminar"> <i class="fa fa-trash-o"></i> </a>
										@endif
									@endif
								</td>
							@endif
