		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="portlet box green-haze">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-smile-o"></i>Edición de Estudiantes
					</div>
					<div class="tools">
				...
				<div class="portlet-body form">
					...
					<form action="" method="post" class="form-horizontal">
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input name="first_name" type="text" class="form-control" placeholder="Ingrese el nombre del Usuario" value="{{ $student->first_name }}">
								...
								<div class="col-md-6">
									<div class="form-group {{ false ? 'has-error' : '' }}">
										...
										<div class="col-md-9">
											<input name="last_name" type="text" class="form-control" placeholder="Ingrese el nombre del Usuario" value="{{ $student->last_name }}">
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'coordinators_students_username_err' ? 'has-error' : '' }}">
										<label class="control-label col-md-3">Usuario</label>
										<div class="col-md-9">
											<div class="input-icon right">
												<i class="fa fa-user"></i>
												<input name="username" type="text" class="form-control" placeholder="Ingrese el nombre del Usuario" value="{{ $student->username }}" readonly required>
											</div>
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								...
								<!--/span-->
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'coordinators_students_email_err' ? 'has-error' : '' }}">
										<label class="control-label col-md-3">Correo</label>
										<div class="col-md-9">
											<div class="input-icon right">
												<i class="fa fa-envelope"></i>
												<input name="email" type="email" placeholder="Ingrese el Correo Electrónico" class="form-control"  value="{{ $student->email }}" required>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="input-icon right">
												<i class="fa fa-eye"></i>
												<input name="display_name" type="text" class="form-control" placeholder="Ingrese el nombre para mostrar" value="{{ $student->display_name }}">
											</div>
											<span class="help-block">This is inline help</span>
										</div>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'coordinators_students_role_err' ? 'has-error' : '' }}">
											...
											<div class="input-group ">
												...
												<select name="role_id" class="form-control select2me" data-placeholder="Seleccione un rol de usuario..." required>
													...
													@foreach( $roles as $role )
														<option value="{{ $role->id }}" {{ $role->id == $student->role_id ? 'selected' : '' }}>{{ $role->title }}</option>
													@endforeach
												</select>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'coordinators_students_password_err' ? 'has-error' : '' }}">
