		...
		<div class="portlet light profile-sidebar-portlet">
			...
			<div class="profile-userbuttons">
				@if( Auth::user()->hasCap('coordinators_students_get_update'))
					<a href="{{ $route }}/update/{{ Hashids::encode($student->id) }}" type="button" class="btn btn-circle green-haze btn-sm">Editar</a>
				@endif
				@if( Auth::user()->hasCap('coordinators_students_get_delete'))
					<a href="{{ $route }}/delete/{{ Hashids::encode($student->id) }}" type="button" class="btn btn-circle btn-danger btn-sm">Eliminar</a>
				@endif
			</div>
			<!-- END SIDEBAR BUTTONS -->
			<!-- SIDEBAR MENU -->
