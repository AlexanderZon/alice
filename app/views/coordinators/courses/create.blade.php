		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="portlet box green-haze">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-notebook"></i>Creación de Cursos
					</div>
					<div class="tools">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'coordinators_courses_title_err' ? 'has-error' : '' }}">
										...
										<div class="col-md-9">
											<input name="title" type="text" class="form-control" placeholder="Ingrese el Título del Curso" required>
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
									...
									<div class="col-md-9">
										<div class="fileinput fileinput-new" data-provides="main_picture">
											...
											<div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
												...
												<img src="{{Course::DEFAULT_MAIN_PICTURE}}" alt=""/>
											</div>
										...
										<div class="fileinput fileinput-new" data-provides="cover_picture">
											...
											<div class="fileinput-new thumbnail" style="width: 200px; height: 50px;">
												<!-- <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt=""/> -->
												<img src="{{Course::DEFAULT_COVER_PICTURE}}" alt=""/>
											</div>
											<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 200px;">
											</div>
											<div>
