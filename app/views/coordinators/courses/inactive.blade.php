	...
	<div class="page-toolbar">
		...
		<div class="btn-group btn-theme-panel">
			@if(Auth::user()->hasCap('coordinators_courses_get_index'))
				<a href="{{ $route }}" class="btn tooltips" data-toggle="Volver al Listado" data-container="body" data-placement="left" data-html="true"  data-original-title="Volver al Listado de Cursos"><i class="icon-arrow-left"></i></a>
			@endif
			...
			<div class="col-md-12">
				...
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="icon-book-open"></i>Listado de Cursos Inactivos
						</div>
						<div class="tools">
							@if(Auth::user()->hasCap('coordinators_courses_get_index'))
