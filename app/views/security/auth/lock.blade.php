...
<div class="page-lock">
	<div class="page-logo">
		<a class="brand" href="/">
		<img class="" src="/assets/images/logo_blank.png" alt="logo" style="max-width:425px" />
		</a>
	</div>
	<div class="page-body">
		<div class="lock-head">
		...
		<div class="lock-body">
			<div class="pull-left lock-avatar-block">
				<img src="{{ $user->profile->getAvatar()}}" class="lock-avatar">
			</div>
			<form class="lock-form pull-left" action="" method="post">
				...
				@endif
				<div class="form-group">
					<input class="" type="hidden" name="_token" value="{{ Crypt::encrypt($user->id) }}"/>
		...
		<div class="lock-bottom">
			<a href="">¿No eres {{ $user->display_name}}?</a>
		</div>
	</div>
