				...
				<div class="portlet-body form">
					...
					<form action="" method="post" class="form-horizontal">
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'capability_name_err' ? 'has-error' : '' }}">
								...
								<!--/span-->
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'capability_controller_err' ? 'has-error' : '' }}">
										...
										<div class="col-md-9">
											<div class="input-group ">
												...
												<select name="crud" class="form-control select2me" data-placeholder="Seleccione un rol de usuario..." required>
													...
													<option value="CREATE" {{ $capability->crud == 'CREATE' ? 'selected' : '' }}>CREATE</option>
													<option value="READ" {{ $capability->crud == 'READ' ? 'selected' : '' }}>READ</option>
													<option value="UPDATE" {{ $capability->crud == 'UPDATE' ? 'selected' : '' }}>UPDATE</option>
													<option value="DELETE" {{ $capability->crud == 'DELETE' ? 'selected' : '' }}>DELETE</option>
												</select>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'capability_route_err' ? 'has-error' : '' }}">
								...
								<div class="col-md-6">
									<div class="form-group {{ $msg_warning['name'] == 'capability_method_err' ? 'has-error' : '' }}">
