...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<ul class="page-breadcrumb breadcrumb">
			@foreach( $breadcrumbs as $breadcumb )
			<li>
				<a href="{{ $route }}">{{ $breadcumb['name'] }}</a><i class="fa fa-circle"></i>
			</li>
			@endforeach
			<li class="active">
				{{ $sections['index'] }}
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat2">
					<div class="display">
						<div class="number">
							<h3 class="font-green-sharp"><span class="currency">0</span> <small class="font-green-sharp">Bs.</small></h3>
					...
					<div class="progress-info">
						<div class="progress">
							...
							<span class="sr-only"><span class="currency">0</span> Bs. Recibidos</span>
							</span>
						</div>
						<div class="status">
