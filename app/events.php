<?php
	...
	Event::listen('notification.students_lessons_write_comment', function($writer, $lesson, $comment){
	...
	Event::listen('notification.students_lessons_reply_comment', function($writer, $lesson, $comment, $parent){
